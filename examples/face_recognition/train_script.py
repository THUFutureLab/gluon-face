...
parser.add_argument('--ctx', '--context', type=str, default="0, 1, 2, 3",
...
parser.add_argument('--lr-mode', '--learning-rate-mode', type=str, default='step',
                    help='Which type to decay learning rate(choose lr scheduler), default is step.')
parser.add_argument('--lr-decay', type=float, default=0.1,
                    help='decay rate of learning rate. default is 0.1.')
parser.add_argument('--lr-decay-iter', type=str, default="60e3, 120e3",
...
parser.add_argument('--niters', '--num_iterations', type=int, default=int(180e3),
...
assert opt.batch_size % len(opt.ctx) == 0, "Per batch on each GPU must be same."
...
ctx = [mx.gpu(i) for i in opt.ctx.split(",")]
